...
export const head = [
  ...
  [
    'meta',
    {
      name: 'keywords',
      content:
        'TaskFlow AI, AI, Task Management, PRD Parser, MCP, Model Context Protocol, DeepSeek, OpenAI, Claude, Cursor, Windsurf, CLI Tool, TypeScript',
    },
  ],
  ...
  [
    'meta',
    {
      ...
      content: '从任务执行升级为思维编排 - 专为开发团队打造的下一代 AI 开发工具',
    },
  ],
  [
    'meta',
    { property: 'og:image', content: 'https://agions.github.io/taskflow-ai/assets/og-image.png' },
  ],
  ...
  [
    'meta',
    { name: 'twitter:image', content: 'https://agions.github.io/taskflow-ai/assets/og-image.png' },
  ],
